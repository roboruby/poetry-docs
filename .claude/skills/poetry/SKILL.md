...
Generated from the poetry registry (72 components + 13 chart components + 7 blocks). After updating
...
- **forms** (`references/forms.md`): button, button_group, calendar, checkbox, combobox, date_field, date_picker, field, file_input, input, input_group, input_otp, label, native_select, number_field, radio_group, select, slider, switch, textarea, time_field, toggle, toggle_group
...
- **data** (`references/data.md`): accordion, avatar, badge, card, carousel, collapsible, data_table, empty, item, metadata_list, stat, table, toolbar
