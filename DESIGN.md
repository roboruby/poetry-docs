...
poetry:
  ...
  - cn: "*"
    files:
    - app/assets/tailwind/styles/style-*.css
    reason: The docs style switcher renders ALL NINE themes as .style-<name>-scoped
      copies (generated by script/build_style_registry.rb) - an app installs one theme;
      this site deliberately ships every fragment.
    created: '2026-07-18'
---
...
- catalog: 87 components - the registry is the truth; read
...
|----|-------|--------|---------|
| `*` | `app/assets/tailwind/styles/style-*.css` | The docs style switcher renders ALL NINE themes as .style-<name>-scoped copies (generated by script/build_style_registry.rb) - an app installs one theme; this site deliberately ships every fragment. | 2026-07-18 |
